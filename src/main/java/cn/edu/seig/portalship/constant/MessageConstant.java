package cn.edu.seig.portalship.constant;
...
public class MessageConstant {
    ...
    public static final String SHIP = "船舶";
    public static final String SHIP_OPERATION = "作业数据";
    ...
    public static final String SHIP_STATUS_INVALID = "船舶状态无效";
